  ...
  if (data && data.length === 0) {
    return (
      <ApiLoading message="You haven't submitted any roles yet.">
        <p>
          This is where a recruiter could see the roles they sent to candidates
          and why they were unacceptable.
        </p>
        <p>
          If you like you can submit a job to yourself to see what will happen
          when your filters are used.
        </p>
        <Link
    ...
    <div className="mb-8">
      <div className="overflow-hidden bg-white shadow sm:rounded-md">
        <div className="px-4 py-5 sm:px-6">
          ...
          <p className="pb-6">
            These are the roles you've submitted to candidate's links.
          </p>
