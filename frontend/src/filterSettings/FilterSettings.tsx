    ...
    case QuestionType.CURRENCY:
      return (
        <Field
          ...
          className="block md:w-1/2 w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-light-blue-500 focus:border-light-blue-500 sm:text-sm"
        />
      );
    ...
    case QuestionType.SELECT_REMOTE_WORK_ALLOWANCE:
      ...
      return (
        <Fieldset
          ...
          name={questionMeta.questionKey}
          id={questionMeta.questionKey}
          className="block md:w-1/2 w-full px-3 py-4 mt-4 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-light-blue-500 focus:border-light-blue-500 sm:text-sm"
      ...
      onSubmit={(values, { setSubmitting }) => {
        ...
        saveFilterSettingMutation.mutate({
          model: {
            ...
            minimumTotalCompensation: values.minimumTotalCompensation || 0,

            askAboutIncludeSuper: values.askAboutIncludeSuper || false,
            ...
            askAboutRemoteAllowance: values.askAboutRemoteAllowance || false,
            remoteAllowance:
              values.remoteAllowance ||
              RemoteAllowance.PARTIAL_WEEK_REMOTE_IN_CITY,

            askAboutRoleLocation: values.askAboutRoleLocation || false,
            ...
            askAboutMinimumLearningTimePercentPerMonth:
              values.askAboutMinimumLearningTimePercentPerMonth || false,
            minimumLearningTimePercentPerMonth:
              values.minimumLearningTimePercentPerMonth || 0,

            askMoreAboutLearningTime: false, // not used :)

            askAboutOvertimeExpected: values.askAboutOvertimeExpected || false,
            rejectIfOvertimeExpected: values.rejectIfOvertimeExpected || false,

            askFamilyFriendlyPolicies:
              values.askFamilyFriendlyPolicies || false,
            mustBeFamilyFriendly: values.mustBeFamilyFriendly || false,

            askMoreDetailsAboutFamilyFriendlyEnvironment:
              values.askMoreDetailsAboutFamilyFriendlyEnvironment || false,
            askAboutOngoingChallenges:
              values.askAboutOngoingChallenges || false,
            askTechnicalPrincipals: values.askTechnicalPrincipals || false,
            // Diversity
            askAboutDiversityProgram: values.askAboutDiversityProgram || false,
            requireActiveDiversityProgram:
              values.requireActiveDiversityProgram || false,

            askMoreAboutDiversity: values.askMoreAboutDiversity || false,

            // Company
            askAboutCompanyAudience: values.askAboutCompanyAudience || false,
            companyAudience: values.companyAudience || CompanyAudience.B_TO_B,

            askAboutCompanyFunding: values.askAboutCompanyFunding || false,
            companyFunding: values.companyFunding || CompanyFunding.DONT_CARE,

            askAboutCompetitiveAdvantage:
              values.askAboutCompetitiveAdvantage || false,

            askAboutNonCompete: values.askAboutNonCompete || false,
            rejectIfMustSignNonCompete: values.rejectIfMustSignNonCompete,

            askAboutNameOfCompany: values.askAboutNameOfCompany || false,
            // meta
            askAboutRoleOfSubmitter: values.askAboutRoleOfSubmitter || false,
            applicantRole: values.applicantRole || ApplicantRole.DONT_CARE,

            lodgementsAllowedPerDay: values.lodgementsAllowedPerDay || 0,
        ...
        <div className="mb-8">
          <div className="px-8 pt-6 pb-6 overflow-hidden bg-white rounded-lg shadow lg:pb-8">
            ...
            <p className="pb-4 mt-1 text-sm ">
              This is where you set up your custom job filters. Any role
              submissions made by recruiters to your sharing link will be
              filtered with these values.
            </p>
            <p className="pb-4 mt-1 text-sm ">
              We will only show the questions you include.
            </p>
            <p className="pb-8 mt-1 text-sm">
              You will only hear about the roles that meet or exceed your
              filters and recruiters can't see your specific filter values.
            </p>

            <p>
              <Link to={"/"} className="font-bold text-light-accent info-link">
                ...
                <div className="px-8 pt-6 pb-6 overflow-hidden bg-white rounded-lg shadow lg:pb-8">
                  <div className="grid grid-cols-12 gap-6">
                          ...
                          <React.Fragment key={question.questionKey}>
                            <div className="col-span-4 md:col-span-2">
                              {question.userCanCustomizeAsking && (
                                <>
                                  <label
                                    htmlFor={question.askQuestionKey}
                                    className="block text-sm font-medium text-gray-700"
                                  >
                                    Include this question
                                  </label>
                                  <ToggleCheckbox
                                    name={question.askQuestionKey}
                                    id={question.askQuestionKey}
                                  />

                                  <ErrorMessage name={question.askQuestionKey}>
                                    {(msg) => (
                            ...
                            <div className="col-span-8 md:col-span-10">
                              ...
                              {mapField(question)}
                              <ErrorMessage name={question.questionKey}>
                                {(msg) => (
                                  <div className="text-red-500">{msg}</div>
                                )}
                              </ErrorMessage>
                    ...
                    <div className="col-span-12">
                      ...
                      <div>
                        {saveFilterSettingMutation.isError && <p>Error!</p>}
