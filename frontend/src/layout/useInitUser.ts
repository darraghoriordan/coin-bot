...
import { ApplicationSupportApi } from "../../../shared-api-client/dist";
      ...
      onSettled: (data) => {
        ...
        if (data?.userWasInitialised === true) {
          setTimeout(function () {
            ...
            console.log("user was initialised, invalidating queries");
            queryClient.invalidateQueries(
              wellKnownSharingLinkQueries.default.sharingLinksGetAll
            );
            queryClient.invalidateQueries(
              wellKnownSharingLinkQueries.default.sharingLinksGetLatest
            );
            queryClient.invalidateQueries(
