...
const SubmitOffer = (): JSX.Element => {
  ...
  const { data: offerSettings, status } = useGetSubmitOfferQuestions(offerId);
    ...
    : {
        ...
        signupMessage: (
          <div className="">
            {" "}
            <p className="my-4">
              You must create an account to submit a job to this candidate. This
              helps us protect candidates from spam and enables us to send you
        ...
        submitOfferMutation.mutate(
          {
            model: {
              ...
              providesSomeMedicalBenefit: values.providesSomeMedicalBenefit,
              ...
              // Culture Details
              whyNotFilledInternally: values.whyNotFilledInternally,
              ...
              familyFriendlyTellMeMore: values.familyFriendlyTellMeMore,
              isOvertimeExpected: values.isOvertimeExpected,

              // Diversity Details
              hasActiveDiversityProgram: values.hasActiveDiversityProgram,
              tellMeMoreAboutDiversity: values.tellMeMoreAboutDiversity,
              // Company Details
              ...
              nonCompeteAgreementRequired: values.nonCompeteAgreementRequired,
            },
          },
      ...
      <Form>
        <div className="mb-8">
          <div className="px-8 pt-6 pb-6 overflow-hidden bg-white rounded-lg shadow lg:pb-8">
            ...
            <p className="my-4">
              Filtered:reduced allows you to submit your role directly to a
              candidates and get a response every time.
            </p>

            <h2 className="text-2xl">How does it work?</h2>
            <p className="my-4">
              After you submit the job we will immediately provide you a report
              that compares your role to the candidate's current preferences for
              their perfect role.
            </p>
            <p className="my-4">
              You get a 100% response rate and receive immediate feedback!
            </p>
              ...
              {authenticationStateChanges.disableSaveButton ? (
                <>
                  <p className="text-base col-span-12">
                    ...
                    candidate. This helps us protect candidates from spam and
                    enables us to send you the report afterwards.
                  </p>
                  <p className="text-base col-span-12">
                    When you're{" "}
                    <button
                    ...
                    we'll populate some of these fields for you.
                  </p>
                </>
              ) : (
                <div className="col-span-12">
                  <div className="inline w-auto">
                    {user && user.picture && (
                      <img
                        className="inline w-8 h-8 rounded-full mr-5"
                        src={user.picture}
        ...
        {offerSettings.map((section) => {
          if (section.questions.every((q) => q.shouldAskQuestion === false)) {
            return undefined;
          }
          return (
            <div className="mb-8" key={section.title}>
              <div className="px-8 pt-6 pb-6 overflow-hidden bg-white rounded-lg shadow lg:pb-8">
                <div className="grid grid-cols-12 gap-6">
                  <h2 className="text-2xl col-span-12">{section.title}</h2>
                  {section.questions.map((question) => {
                    return (
                      <div
                        key={question.questionKey}
                        className={`col-span-12 ${
                          question.shouldAskQuestion ? `block` : `hidden`
                        }`}
                      >
                        <label
                        ...
                        <DynamicSubmitField questionMeta={question} />
                        <ErrorMessage name={question.answerKey}>
                          {(msg) => <div className="text-red-500">{msg}</div>}
                        </ErrorMessage>
                      </div>
                    );
        ...
        <div className="mb-8">
          <div className="px-8 pt-6 pb-6 overflow-hidden bg-white rounded-lg shadow lg:pb-8">
            <div className="grid grid-cols-12 gap-6">
              <h2 className="text-2xl col-span-12">Submit the job</h2>
              <div className="col-span-12">
                {authenticationStateChanges.signupMessage}
              </div>{" "}
              <div className="col-span-12 space-x-6">
                {formSubmitting ? (
                  ...
                  <button
                    type="submit"
                    disabled={authenticationStateChanges.disableSaveButton}
                  ...
                  >
                    Click to submit this job to the candidate
                  </button>
                )}
              </div>
              <div className="col-span-12">
